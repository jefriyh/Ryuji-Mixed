...
public enum FindPeopleCommands {
    ...
    GO_FORWARD("please go forward", "go forward", ActionType.GO_FORWARD.id()),
    GO_BACKWARD("please go backward", "go backward", ActionType.GO_BACKWARD.id()),
    TURN_LEFT("please turn left", "turn left", ActionType.TURN_LEFT.id()),
    TURN_RIGHT("please turn right", "turn right", ActionType.TURN_RIGHT.id());
